...
- **Stoppa ström ≠ stoppa analys (v0.9)** — ”Stoppa ström” stänger bara videon till GUI:t; kameraworkern, YOLO och HA-event fortsätter köra på servern. (”Starta kamera” startar workern igen om den stoppats helt.) Streamen är **AV vid uppstart** – starta manuellt eller sätt `LIVE_STREAM_AUTOSTART=true` i .env.
